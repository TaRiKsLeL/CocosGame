...
const int PLAYER_CATEGORY_BM		{ 0b00000001 };

const int NPC_CATEGORY_BM			{ 0b00000010 };
const int BUILDER_CATEGORY_BM		{ 0b00000100 };

const int SLAVE_TRAIDER_CATEGORY_BM	{ 0b00010000 };
const int ENEMY_CATEGORY_BM			{ 0b00100000 };

const int BUILDING_CATEGORY_BM		{ 0b00001000 };
const int WALL_CATEGORY_BM			{ 0b01000000 };



const int PLAYER_COLLIDE_BM			{ 0b11111111 };
const int NPC_COLLIDE_BM			{ PLAYER_CATEGORY_BM | ENEMY_CATEGORY_BM};
const int BUILDER_COLLIDE_BM		{ PLAYER_CATEGORY_BM | BUILDING_CATEGORY_BM | WALL_CATEGORY_BM | ENEMY_CATEGORY_BM };
