...
const int PLAYER_CATEGORY_BM		{ 0b0000000001 };

const int BUILDER_CATEGORY_BM		{ 0b0000000010 };
const int WARRIOR_CATEGORY_BM		{ 0b0000000100 };
const int WORKER_CATEGORY_BM		{ 0b0000001000 };
const int CITIZEN_CATEGORY_BM		{ 0b0000010000 };

const int SLAVE_TRAIDER_CATEGORY_BM	{ 0b0000100000 };
const int ENEMY_CATEGORY_BM			{ 0b0001000000 };

const int WALL_CATEGORY_BM			{ 0b0010000000 };
const int TOWER_CATEGORY_BM			{ 0b0100000000 };
const int MINE_CATEGORY_BM			{ 0b1000000000 };



const int PLAYER_COLLIDE_BM			{ 0b1111111111 };
...
const int ENEMY_COLLIDE_BM			{ PLAYER_CATEGORY_BM | BUILDER_CATEGORY_BM | WARRIOR_CATEGORY_BM | WORKER_CATEGORY_BM | WALL_CATEGORY_BM };
